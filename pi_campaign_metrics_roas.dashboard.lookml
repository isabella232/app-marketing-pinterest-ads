- dashboard: pi_campaign_metrics_roas
  ...
  - title: Return On Ad Spend To Date
    ...
    series_colors:
      ...
      fact.average_value_per_cost: "#3EB0D5"
    series_labels:
  ...
  - title: Return On Ad Spend By Bid Type
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{axisId: fact.average_value_per_cost,
            id: fact.average_value_per_cost, name: ROAS}], showLabels: false, showValues: false,
